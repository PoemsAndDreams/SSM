...
import com.yutian.springMVC.pojo.User;
...
public class TestParamController {
     ...
     * 4、@RequestHeader：将请求头信息和控制器方法的形参绑定 获取请求头信息中的referer参数  :  referer:http://localhost:8080/springMVC/
